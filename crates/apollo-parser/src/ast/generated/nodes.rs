...
impl AstNode for Definition {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        ...
        match syntax.kind() {
            ...
            FRAGMENT_DEFINITION => Some(Definition::FragmentDefinition(FragmentDefinition {
                syntax,
            })),
            DIRECTIVE_DEFINITION => Some(Definition::DirectiveDefinition(DirectiveDefinition {
                syntax,
            })),
            SCHEMA_DEFINITION => Some(Definition::SchemaDefinition(SchemaDefinition { syntax })),
            SCALAR_TYPE_DEFINITION => {
                Some(Definition::ScalarTypeDefinition(ScalarTypeDefinition {
                    syntax,
                }))
            }
            OBJECT_TYPE_DEFINITION => {
                Some(Definition::ObjectTypeDefinition(ObjectTypeDefinition {
                    syntax,
                }))
            }
            INTERFACE_TYPE_DEFINITION => Some(Definition::InterfaceTypeDefinition(
                InterfaceTypeDefinition { syntax },
            )),
            UNION_TYPE_DEFINITION => Some(Definition::UnionTypeDefinition(UnionTypeDefinition {
                syntax,
            })),
            ENUM_TYPE_DEFINITION => Some(Definition::EnumTypeDefinition(EnumTypeDefinition {
                syntax,
            })),
            INPUT_OBJECT_TYPE_DEFINITION => Some(Definition::InputObjectTypeDefinition(
                InputObjectTypeDefinition { syntax },
            )),
            SCHEMA_EXTENSION => Some(Definition::SchemaExtension(SchemaExtension { syntax })),
            SCALAR_TYPE_EXTENSION => Some(Definition::ScalarTypeExtension(ScalarTypeExtension {
                syntax,
            })),
            OBJECT_TYPE_EXTENSION => Some(Definition::ObjectTypeExtension(ObjectTypeExtension {
                syntax,
            })),
            INTERFACE_TYPE_EXTENSION => {
                Some(Definition::InterfaceTypeExtension(InterfaceTypeExtension {
                    syntax,
                }))
            }
            UNION_TYPE_EXTENSION => Some(Definition::UnionTypeExtension(UnionTypeExtension {
                syntax,
            })),
            ENUM_TYPE_EXTENSION => {
                Some(Definition::EnumTypeExtension(EnumTypeExtension { syntax }))
            }
            INPUT_OBJECT_TYPE_EXTENSION => Some(Definition::InputObjectTypeExtension(
                InputObjectTypeExtension { syntax },
            )),
            _ => None,
        }
    }
...
impl AstNode for Selection {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        ...
        match syntax.kind() {
            ...
            INLINE_FRAGMENT => Some(Selection::InlineFragment(InlineFragment { syntax })),
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
...
impl AstNode for Value {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        ...
        match syntax.kind() {
            ...
            FLOAT_VALUE => Some(Value::FloatValue(FloatValue { syntax })),
            INT_VALUE => Some(Value::IntValue(IntValue { syntax })),
            BOOLEAN_VALUE => Some(Value::BooleanValue(BooleanValue { syntax })),
            NULL_VALUE => Some(Value::NullValue(NullValue { syntax })),
            ENUM_VALUE => Some(Value::EnumValue(EnumValue { syntax })),
            LIST_VALUE => Some(Value::ListValue(ListValue { syntax })),
            OBJECT_VALUE => Some(Value::ObjectValue(ObjectValue { syntax })),
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
...
impl AstNode for Type {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        ...
        match syntax.kind() {
            ...
            NON_NULL_TYPE => Some(Type::NonNullType(NonNullType { syntax })),
            _ => None,
        }
    }
    fn syntax(&self) -> &SyntaxNode {
