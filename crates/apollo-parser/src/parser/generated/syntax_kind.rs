...
impl SyntaxKind {
    ...
    pub fn is_punct(self) -> bool {
        match self {
            BANG | L_PAREN | R_PAREN | L_CURLY | R_CURLY | L_BRACK | R_BRACK | COMMA | AT
            | DOLLAR | PIPE | SPREAD | EQ | COLON => true,
            _ => false,
        }
    }
